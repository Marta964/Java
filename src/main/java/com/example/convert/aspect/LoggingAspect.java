...
public class LoggingAspect {
    @Before("com.example.convert.aspect.LoggingPointcuts.allMethodsFromControllers()"
            + "|| com.example.convert.aspect.LoggingPointcuts.allMethodsFromServices()")
    ...
    @AfterReturning(value = "com.example.convert.aspect.LoggingPointcuts.allMethodsFromControllers()"
            + "|| com.example.convert.aspect.LoggingPointcuts.allMethodsFromServices()",
            returning = "result")
    ...
    @AfterThrowing(value = "com.example.convert.aspect.LoggingPointcuts.allMethodsFromServices()",
            throwing = "exception")
